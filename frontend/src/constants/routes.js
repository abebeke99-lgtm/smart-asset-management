...
export const ROUTES = {
  ...
  ICT_ASSIGNMENTS: '/ict/assignments',
  ICT_ASSET_REQUESTS: '/ict/asset-requests',
  ICT_MAINTENANCE: '/ict/maintenance',
  ICT_MAINTENANCE_REPAIR_HISTORY: '/ict/repairs',
  ICT_MAINTENANCE_DEVICE_HEALTH: '/ict/device-health',
  ICT_RFID: '/ict/tracking',
  ICT_REPORTS: '/ict/reports',
  ICT_ASSET_ANALYTICS: '/ict/analytics',
