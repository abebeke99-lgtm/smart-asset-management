...
const AdminDashboard = () => {
  ...
  const maintenanceStatusChartData = useMemo(() => ({
    labels: [t.pendingMaintenance, t.inProgressMaintenance, t.completedMaintenance, t.overdueMaintenance],
    datasets: [{
      data: [stats.maintenanceSummary.open, stats.maintenanceSummary.inProgress, stats.maintenanceSummary.completed, stats.maintenanceSummary.overdue],
      backgroundColor: [colors.warning, colors.primary, colors.success, colors.danger],
      borderColor: isDark ? '#1e2d45' : '#ffffff',
      borderWidth: 2
    }]
  }), [stats.maintenanceSummary, t.pendingMaintenance, t.inProgressMaintenance, t.completedMaintenance, t.overdueMaintenance, colors, isDark]);
  ...
  return (
    <div className="admin-dashboard-shell" style={{
      ...
      {/* Header */}
      <div className="admin-dashboard-stats-grid" style={{
        display: 'flex',
      ...
      <div style={{
        ...
        {[
          ...
          { label: t.overdue || 'Overdue', value: stats.maintenanceSummary.overdue, icon: Activity, color: colors.danger, path: '/admin/maintenance' },
          { label: t.completed || 'Completed', value: stats.maintenanceSummary.completed, icon: CheckCircle, color: colors.success, path: '/admin/maintenance' },
      ...
      {/* Quick Actions */}
      <div className="admin-dashboard-charts-grid" style={{
        background: isDark ? '#1e2d45' : '#ffffff',
        padding: '20px',
        borderRadius: '12px',
        border: `1px solid ${isDark ? '#32465f' : '#e8edf5'}`,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h3 style={{ color: isDark ? '#c8dcf5' : '#1a365d', fontSize: '1rem', marginBottom: '16px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '8px' }}>
            <Wrench size={17} /> {t.maintenanceSummary}
          </h3>
          <div style={{ height: '260px', position: 'relative' }}>
            <Doughnut data={maintenanceStatusChartData} options={statusChartOptions} />
          </div>
        </div>
        <div style={{
          background: isDark ? '#1e2d45' : '#ffffff',
