...
import { ArrowLeftRight, BarChart3, Bell, Building2, ChevronDown, ChevronRight, ClipboardCheck, ClipboardList, DatabaseBackup, Github, LayoutDashboard, Linkedin, LogOut, Menu, Package, Radio, Search, Settings, Users, Wrench, X } from 'lucide-react';
      ...
      <div style={{ display: 'flex', gap: '15px', alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        {user ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <button type="button" aria-label="Open global search" title="Search assets" onClick={() => navigate(`${dashboardRoute}?search=`)} style={{ background: 'rgba(0,51,102,0.35)', border: '1px solid rgba(255,255,255,0.35)', color: '#ffffff', width: '36px', height: '36px', borderRadius: '8px', display: 'grid', placeItems: 'center', cursor: 'pointer' }}>
              <Search size={17} />
            </button>
            <Link to={`${dashboardRoute}/notifications`} aria-label="Open notifications" title="Notifications" style={{ background: 'rgba(0,51,102,0.35)', border: '1px solid rgba(255,255,255,0.35)', color: '#ffffff', width: '36px', height: '36px', borderRadius: '8px', display: 'grid', placeItems: 'center' }}>
              <Bell size={17} />
            </Link>
            <div style={{
              width: '36px',
            ...
            <button type="button" onClick={handleLogout} aria-label={t.logout} title={t.logout} style={{ background: 'transparent', border: '1px solid rgba(255,255,255,0.35)', color: '#ffffff', padding: '8px 10px', borderRadius: '8px', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '6px', fontWeight: 700 }}>
